...
- `equal` uses structural equality for acyclic Otium arrays in place of Scheme vectors. Its cyclic-list helper is disabled by upstream and is not part of the timed workload.
