...
static Value nat_current_jiffy(Vm& vm, u32, u32 argc) {
...
static Value nat_jiffies_per_second(Vm& vm, u32, u32 argc) {
  OT_TRY(need_argc(vm, "jiffies-per-second", argc, 0, 0));
  return int_v(1000000000);
}

static Value nat_current_second(Vm& vm, u32, u32 argc) {
