...
// constructors
inline Value nil_v()          { Value v; v.tag = Tag::Nil;   v.i = 0; return v; }
inline Value null_v()         { Value v; v.tag = Tag::Null;  v.i = 0; return v; }
inline Value bool_v(bool b)   { Value v; v.tag = b ? Tag::True : Tag::False; v.i = 0; return v; }
inline Value int_v(i64 i)     { Value v; v.tag = Tag::Int;   v.i = i; return v; }
inline Value float_v(f64 f)   { Value v; v.tag = Tag::Float; v.f = f; return v; }
inline Value symbol_v(u32 id) { Value v; v.tag = Tag::Symbol;  v.i = 0; v.id = id; return v; }
inline Value keyword_v(u32 id){ Value v; v.tag = Tag::Keyword; v.i = 0; v.id = id; return v; }
inline Value obj_v(Tag t, Obj* o) { Value v; v.tag = t; v.obj = o; return v; }
inline Value unwind_v()       { Value v; v.tag = Tag::Unwind; v.i = 0; return v; }
...
#define OT_TRY(expr) \
  { ::ot::Value _v = (expr); if (_v.tag == ::ot::Tag::Unwind) return _v; }
