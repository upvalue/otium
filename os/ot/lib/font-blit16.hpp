...
// Each glyph is encoded as a 16-bit integer with bits representing pixels
// Bit 15 is used for vertical offset (descenders like 'g', 'y', etc.)
static const uint16_t FONT_GLYPHS[95] = {
